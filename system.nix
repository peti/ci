...
mapTestOn {
  ...
  haskellPackages.BNFC = supportedSystems;
  haskellPackages.cabalInstall = supportedSystems;
  haskellPackages.doctest = supportedSystems;
  haskellPackages.ghcMod = supportedSystems;
  haskellPackages.GLUT = supportedSystems;
  haskellPackages.HList = supportedSystems;
  ...
  haskellPackages.uuParsinglib = supportedSystems;
  haskellPackages.xmobar = supportedSystems;
  haskellPackages.xmonadContrib = supportedSystems;
  haskellPackages.xmonadExtras = supportedSystems;
