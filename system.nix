...
mapTestOn {
  ...
  haskellPackages_ghc782.BNFC = supportedSystems;
  haskellPackages_ghc782.cabalInstall = supportedSystems;
  haskellPackages_ghc782.doctest = supportedSystems;
  haskellPackages_ghc782.ghcMod = supportedSystems;
  haskellPackages_ghc782.GLUT = supportedSystems;
  haskellPackages_ghc782.HList = supportedSystems;
  haskellPackages_ghc782.hspec = supportedSystems;
  haskellPackages_ghc782.lens = supportedSystems;
  haskellPackages_ghc782.OpenGL = supportedSystems;
  haskellPackages_ghc782.pandoc = supportedSystems;
  haskellPackages_ghc782.smallcheck = supportedSystems;
  haskellPackages_ghc782.uuParsinglib = supportedSystems;
  haskellPackages_ghc782.xmobar = supportedSystems;
  haskellPackages_ghc782.xmonadContrib = supportedSystems;
  haskellPackages_ghc782.xmonadExtras = supportedSystems;
  haskellPackages_ghc782.xmonad = supportedSystems;
